...
class BaseValidator:
    ...
    def __call__(self, trainer=None, model=None):
        ...
        ### HERE IS WHERE WE USE OUR QUANTIZATION ###
        ### model.model isinstance of DetectionModel (ultralytics.nn.tasks)
        ### model.model.model is a nn.Sequential that is converted
        ### to use the proposed dynamic quantization framework
